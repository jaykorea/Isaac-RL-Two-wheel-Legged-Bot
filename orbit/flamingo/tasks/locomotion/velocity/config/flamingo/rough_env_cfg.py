...
# Pre-defined configs
##
from omni.isaac.orbit_assets.flamingo import FLAMINGO_CFG  # isort: skip
...
class FlamingoRewardsCfg(RewardsCfg):
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*_shoulder_link", ".*_leg_link"]), "threshold": 1.0},
    )
...
class FlamingoRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # terminations
        self.terminations.base_contact.params["sensor_cfg"].body_names = ["base_link", ".*_shoulder_link", ".*_leg_link"]
