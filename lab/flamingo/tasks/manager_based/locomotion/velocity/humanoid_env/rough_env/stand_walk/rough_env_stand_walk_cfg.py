...
class HumanoidRewardsCfg():
    ...
    track_ang_vel_z_exp = RewTerm(
        func=mdp_walk.track_ang_vel_z_world_exp, weight=1.0, params={"command_name": "base_velocity", "std": 0.5}
    )
    feet_slide = RewTerm(
        func=mdp.feet_slide,
        weight=-0.4,
    ...
    dof_acc_l2 = RewTerm(func=mdp.joint_acc_l2, weight=-1.5e-7, params={"asset_cfg": SceneEntityCfg("robot", [".*_hip_.*", ".*_knee_joint"])})  # default: -2.5e-7
