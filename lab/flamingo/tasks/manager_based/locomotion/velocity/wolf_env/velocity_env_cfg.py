...
class ActionsCfg:
    ...
    joint_pos_front_left = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=
        [
    ...
    joint_pos_front_right = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=
        [
    ...
    joint_pos_back_left = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=[
            "HAA_back_left_joint",
            "HFE_back_left_joint",
    ...
    joint_pos_back_right = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=[
...
class ObservationsCfg:
    ...
    class InfoCfg(ObsGroup):
        ...
        base_projected_gravity = ObsTerm(func=mdp.projected_gravity, scale=1.0)  # default: -0.05
        actions = ObsTerm(func=mdp.last_action)
