...
import lab.flamingo.tasks.manager_based.navigation.mdp as mdp
...
class ActionsCfg:
    ...
    flamingo_pre_trained_policy_action: mdp.FlamingoPreTrainedPolicyActionCfg = mdp.FlamingoPreTrainedPolicyActionCfg(
        ...
        low_level_actions_wheels=LOW_LEVEL_ENV_CFG.actions.wheel_vel,
    ...
    def __post_init__(self):
        ...
        if self.scene.height_scanner is not None:
            self.scene.height_scanner.update_period = (
                self.actions.flamingo_pre_trained_policy_action.low_level_decimation * self.sim.dt
            )
